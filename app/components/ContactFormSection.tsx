        ...
        <div className="container mx-auto px-6">
          <div className="-mx-4 flex flex-wrap lg:justify-between">
            <div className="w-full px-10 lg:w-1/2 xl:w-6/12">
              <div className="mb-12 max-w-1/2 lg:mb-0">
                ...
                <div className="mb-8 flex w-full max-w-[370px]">
                  ...
                  <div className="w-full">
                    <h4 className="mb-1 text-3xl font-bold text-black">
                      Our Location
                    </h4>
                    <p className="text-xl text-black">
                      132 Jan Smuts Avenue, Parkwood, Rosebank, Johannesburg, 2193                     </p>
                  </div>
                </div>
              ...
              <div className="relative rounded-lg bg-white p-8 shadow-lg sm:p-12">
                <form onSubmit={handleSubmit}>
                  ...
                  <div>
                    <button
                      type="submit"
                      className="w-full rounded border border-primary bg-gray-600 p-3 text-white transition hover:bg-opacity-90"
                    >
                      Send Message
                    </button>
                  </div>
