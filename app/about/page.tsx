...
export default function AboutPage() {
  return (
    <div className="min-h-screen pt-20">
      ...
      <section className="relative py-20 bg-gradient-to-b from-black to-black text-white">
        <div className="container mx-auto px-6">
          <div className="max-w-4xl mx-auto text-center">
            <h1 className="text-5xl font-bold mb-6">About Africa Refined</h1>
      ...
      <section className="py-20 bg-gray-50">
        <div className="container mx-auto px-6">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-3xl font-bold mb-12 text-center gradient-text">Our Mission, Vision & Values</h2>
        ...
        <div className="container mx-auto px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-12">
            <div className="bg-red-50 rounded-xl p-6 text-center">
              ...
              <h3 className="text-3xl font-bold mb-2 text-red-600">50+</h3>
              <p className="text-gray-700">Community Projects Completed</p>
            </div>
            <div className="bg-red-50 rounded-xl p-6 text-center">
              <div className="flex justify-center mb-4">
                <Users className="w-12 h-12 text-red-600" />
              </div>
              <h3 className="text-3xl font-bold mb-2 text-red-600">10k+</h3>
            ...
            <div className="bg-red-50 rounded-xl p-6 text-center">
              ...
              <h3 className="text-3xl font-bold mb-2 text-red-600">5k+</h3>
            ...
            <div className="bg-red-50 rounded-xl p-6 text-center">
              ...
              <h3 className="text-3xl font-bold mb-2 text-red-600">20+</h3>
      ...
      <section className="py-20 bg-gray-50">
        <div className="container mx-auto px-6">
          <h2 className="text-3xl font-bold mb-12 text-center gradient-text">Key Focus Areas</h2>
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="bg-white p-6 rounded-lg shadow-md">
              <div className="w-16 h-16 bg-red-100 rounded-full flex items-center justify-center mb-6">
                <GraduationCap className="w-8 h-8 text-red-600" />
              </div>
              <h3 className="text-xl font-bold mb-4 text-red-600">Education and Awareness</h3>
              <p className="text-gray-700">
            ...
            <div className="bg-white p-6 rounded-lg shadow-md">
              ...
              <h3 className="text-xl font-bold mb-4 text-red-600">Health and Well-being</h3>
              <p className="text-gray-700">
            ...
            <div className="bg-white p-6 rounded-lg shadow-md">
              ...
              <h3 className="text-xl font-bold mb-4 text-red-600">Sustainable Development</h3>
              <p className="text-gray-700">
            ...
            <div className="bg-white p-6 rounded-lg shadow-md">
              ...
              <h3 className="text-xl font-bold mb-4 text-red-600">Community Resilience</h3>
              <p className="text-gray-700">
